...
it("renames and merges exact owner-scoped wings, preserves flight data and rejects stale counts", async () => {
  ...
  expect(await wings.listOwnWings(owners[0])).toEqual(expect.arrayContaining([{ name: "Ozone Rush 4", count: 3, durationS: 360, hidden: false, tandem: false }, { name: null, count: 1, durationS: 120, hidden: false, tandem: false }]));
