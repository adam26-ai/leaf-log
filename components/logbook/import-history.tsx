...
export function ImportHistory({ imports }: { imports: ImportReceipt[] }) {
  ...
  async function undo(id: string) {
    ...
    try {
      ...
      setConfirmId(null); setMessage(`${result.removed} ${result.removed === 1 ? "entry" : "entries"} removed. ${result.retained} kept because of changes or attached content.`); router.refresh();
