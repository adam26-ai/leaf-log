...
it("switches the time display between clock time and elapsed flight time", () => {
  const view = render(<PlaybackStatus time={0} elapsedTime={0} speed={1} takeoffMs={12 * 60 * 60 * 1000} offsetMin={0}
  ...
  view.rerender(<PlaybackStatus time={75} elapsedTime={75} speed={1} takeoffMs={12 * 60 * 60 * 1000} offsetMin={0}
    trackDisplay="elapsed" onSpeed={vi.fn()} onTrackDisplay={vi.fn()} />);
