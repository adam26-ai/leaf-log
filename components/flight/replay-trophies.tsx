...
export function ReplayTrophies({ flightId, trophies, routes }: { flightId: string; trophies: FlightTrophy[]; routes: XcShape[] }) {
  return <div className="flex flex-wrap items-center justify-center gap-1">{trophies.map(trophy => <TrophyPill key={trophy.category} trophies={[trophy]} placement="below-right"
